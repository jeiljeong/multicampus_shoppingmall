...
50000, 'jeans4.jpg','찢어진 스키니 청바지 입니다.',sysdate,10);

insert into contents(contentsno, cateno, pname, price, filename, detail, rdate, stock)
values((select nvl(max(contentsno),0)+1 from contents), 2, 'Big Bag',
50000, 'bag1.jpg','찢 강',sysdate,10);
...
where cateno = 1 and pname='Big Bag';
